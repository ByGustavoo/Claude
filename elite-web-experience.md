...
6. Olhe o console do navegador. Erro de JS, imagem 404 e aviso de hidratação são problemas reais, mesmo quando a tela parece certa.
7. Reduza a janela e confira ao menos uma largura mobile e uma desktop.
8. Critique, corrija e inspecione de novo.

**Sem navegador**, faça a análise pelo código e diga isso de forma explícita ao usuário, apontando o que ficou por validar.

**Nunca afirme ter inspecionado visualmente algo que você não viu.** Essa é a regra mais importante desta seção. Relatar uma verificação que não aconteceu destrói a confiança em todo o restante do trabalho — inclusive nas partes que estavam certas.
